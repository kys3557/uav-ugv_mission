...
private:
  ...
  void timer_callback()
  {
    ...
    switch (c)
    {
      ...
      case '0':                              // 숫자패드 0
        send_gimbal_target_pitch_dgree(0.0); // 정면 (0°)
        break;
      case '1':                                // 숫자패드 1
        send_gimbal_target_pitch_dgree(-10.0); // 10° 아래
        break;  
      case '2':                                // 숫자패드 2
        send_gimbal_target_pitch_dgree(-20.0); // 20° 아래
        break;
      case '3':                                // 숫자패드 3
        send_gimbal_target_pitch_dgree(-30.0); // 30° 아래
        break;
      case '4':                                // 숫자패드 4
        send_gimbal_target_pitch_dgree(-40.0); // 40° 아래
        break;
      case '5':                                // 숫자패드 5
        send_gimbal_target_pitch_dgree(-50.0); // 50° 아래
        break;
      case '6':                                // 숫자패드 6
        send_gimbal_target_pitch_dgree(-60.0); // 60° 아래
        break;
      case '7':                                // 숫자패드 7
        send_gimbal_target_pitch_dgree(-70.0); // 70° 아래
        break;
      case '8':                                // 숫자패드 8
        send_gimbal_target_pitch_dgree(-80.0); // 80° 아래
        break;
      case '9':                                // 숫자패드 9
        send_gimbal_target_pitch_dgree(-90.0); // 아래로 (90°)
        break;
      case 's':
